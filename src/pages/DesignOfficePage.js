...
import { 
    ...
    Briefcase, Filter, BarChart2, // <-- BarChart2 geri eklendi
...
const DesignOfficePage = ({ projects, personnel, loggedInUser }) => {
    ...
    // YENİ: PERFORMANS İSTATİSTİKLERİNİ HESAPLA (Her Tasarımcı İçin)
    const performanceStats = useMemo(() => {
        if (!isManager) return []; // Sadece yöneticiler görebilir
        ...
        // Puan Hesapla (Zamanında Bitirme Oranı)
    ...
    // Kart Seçimine Göre Listeyi Filtrele
